    ...
    <div className="bg-white text-gray-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="border border-green-600 text-green-600 px-5 py-2 rounded-xl hover:bg-green-50 transition"
            >
              Login
            </Link>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-6xl font-bold leading-tight mt-6">
              Manage Your Gym Smarter With FitZone Gym
            </h1>

            <p className="text-gray-500 text-lg mt-6 leading-relaxed">
              Powerful all-in-one gym management platform with member management,
              QR check-ins, class booking, analytics, and trainer dashboards for
            ...
            <div className="flex gap-4 mt-8">
              <Link
                href="/signup"
                className="bg-green-600 hover:bg-green-700 text-white px-7 py-4 rounded-2xl text-lg font-semibold transition"
              >
                Start Free Trial
              </Link>
              ...
              <Link
                href="/login"
                className="border border-gray-300 hover:border-green-600 hover:text-green-600 px-7 py-4 rounded-2xl text-lg transition"
              >
                Login
              </Link>
            </div>
          ...
          {/* HERO CARD */}
          <div className="bg-gradient-to-br from-green-500 to-green-700 rounded-[40px] p-10 text-white shadow-2xl">
            <div className="space-y-6">
              <div className="bg-white/10 backdrop-blur rounded-2xl p-5">
                <p className="text-green-100">
                  Active Members
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {pricing.map((item, index) => (
              <div
                key={index}
                className="border border-gray-100 rounded-3xl p-8 shadow-sm hover:shadow-2xl transition duration-300"
              >
                <h3 className="text-3xl font-bold">
                  {item.name}
                </h3>
                ...
                <button className="w-full bg-green-600 hover:bg-green-700 text-white py-4 rounded-2xl mt-10 font-semibold transition">
                  Choose Plan
                </button>
              </div>
            ))}
      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-green-100 text-lg">
            Start managing your gym professionally today with FitZone Gym.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-10 justify-center">
            <input
              type="email"
              placeholder="Enter your email"
              className="px-6 py-4 rounded-2xl text-gray-900 w-full md:w-[400px] outline-none"
            />

            <button className="bg-white text-green-700 px-8 py-4 rounded-2xl font-bold hover:bg-gray-100 transition">
              Contact Us
            </button>
          </div>
        </div>
